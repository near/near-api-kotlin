...
class MethodUtils {
    ...
    companion object {
        ...
        fun String.convertNearToAmount() : Float {
            val inputNear = this.toFloat()
            val constValueInBI = StringUtils.HARD_CODED_FOR_CONVERTING_NEAR_VALUE.toFloat()
            return (inputNear / constValueInBI)
        }
