...
data class ViewContractStateResult(
    ...
    companion object {
        @JvmStatic
        @JvmName("create")
        fun Response.toViewContractState(): ViewContractStateResult {
            val gson = Gson()
            if (this.isSuccessful) {
                this.body?.let {
                    return gson.fromJson(it.string(), ViewContractStateResult::class.java)
                } ?: ViewContractStateResult()
            }
            return ViewContractStateResult()
        }
    }
}
